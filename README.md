在savicsw的基础上修改，主要改动如下：
1. 论文扉页的“学位论文”四个字修正为方正小标宋简体
2. “独创性声明”和“论文使用授权”等字修正为方正大标宋简体
3. 缺少pages字段的引用最后不再多一个逗号（针对arxiv和学位论文等情况）

需要自行下载方正小标宋简体和方正大标宋简体的字体文件（office不一定带，网上很容易找到），分别重命名为FZXBSJW.TTF和FZDBSJW.TTF放在fonts目录下。
